...
setup(name='nnunet',
      ...
      entry_points={
          'console_scripts': [
              ...
              'nnUNet_postprocess = nnunet.postprocessing.connected_components:postprocess_main',
              'universal_determine_postprocessing = nnunet.postprocessing.connected_components:determin_postprocess_main',
          ],
      },
